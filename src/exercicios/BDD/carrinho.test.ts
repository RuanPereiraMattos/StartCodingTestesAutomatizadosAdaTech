...
describe("Carrinho", () => {
    ...
    it("calcularTotal() sem desconto com frete cobrado", () => {
        const item: Item = {
            nome: "Sabão em Pó",
            precoEmCentavos: 19_999,
            quantidade: 1
        };
        const carrinho: Carrinho = { itens: [item] };
        expect(calcularTotal(carrinho)).toEqual(21_499);
    });

    it("calcularTotal() com desconto com frete gratis", () => {
        const item: Item = {
            nome: "Sabão em Pó",
